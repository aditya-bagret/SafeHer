//at > /home/claude/report.js << 'JSEOF'
const {
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync("/home/claude/SafeHer_Project_Report.docx", buf);
...
Command argument is 121_112 bytes, exceeding the 100_000-byte per-argument limit. For large content, pipe via stdin or use a file-write API instead of embedding the content inline in the command. Argument preview: "cat > /home/claude/report.js << 'JSEOF'\nconst {\n  Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell,\n  AlignmentType, BorderStyle, WidthType, ShadingType, VerticalAlign,\n  LevelFormat, "